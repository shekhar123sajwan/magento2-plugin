...
class Search extends \Magento\Framework\View\Element\Template
{
	...
	public function getSearchUrl($obj)
	{
		...
		return $url->getUrl('search/index');
	}

	
	public function getAllSearchOption(){
        
		$options = [ ['label' => 'Search Videos', 'value' => 'videos' ],['label' => 'Search Video Profile', 'value' => 'pro' ],
                     ['label' => 'Search By Tag', 'value' => 'v_tag']	
        			 ] ;
		return $options;
	}
    ...
    {
         $url = $this->_urlFactory->create();
		 return $url->getUrl('voice/search'); 
