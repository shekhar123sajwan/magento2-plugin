...
class DisbleAllowed extends \Magento\Backend\App\Action {
        ...
        if ($isPost) {
            ...
            try {
                foreach ($selected_ids as $selected_id) {
                    ...
                    $customer->setCustomAttribute('vv_always_allowed', 0);
                    $customerModel->save($customer);
                }

                // Display success message
                $this->messageManager->addSuccess(__('Selected user accounts have been removed from Video Allowed List.'));
